<template>
  ...
  <!-- Checkin Detail Modal (replaces ion-modal) -->
  <div
    v-if="isRequestModalOpen"
    class="fixed inset-0 bg-black/40 z-50 flex items-end justify-center"
    @click.self="closeRequestModal"
  >
    <div class="bg-white w-full sm:w-96 rounded-t-xl">
      <RequestActionSheet
...
const isFilterOpen = ref(false)   // replaces ion-modal trigger
...
function applyFilters() {
  prepareFilters()
  fetchDocumentList()
  isFilterOpen.value = false   // replaces modalController.dismiss()
